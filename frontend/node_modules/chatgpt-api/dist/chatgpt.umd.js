(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('crypto'), require('util'), require('os'), require('tty'), require('http'), require('https'), require('assert'), require('stream'), require('url'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['crypto', 'util', 'os', 'tty', 'http', 'https', 'assert', 'stream', 'url', 'zlib'], factory) :
    (global.chatgpt = factory(global.crypto,global.util,global.os,global.tty,global.http,global.https,global.assert,global.stream,global.url,global.zlib));
}(this, (function (crypto,util,os,tty,http,https,assert,stream,url,zlib) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    const uuidv4 = (0, util.deprecate)(() => (0, esmNode.v4)(), 'uuidv4() is deprecated. Use v4() from the uuid module instead.');
    exports.uuid = uuidv4;
    const isUuid = (0, util.deprecate)((value) => (0, esmNode.validate)(value) && ((0, esmNode.version)(value) === 4 || (0, esmNode.version)(value) === 5), 'isUuid() is deprecated. Use validate() from the uuid module instead.');
    exports.isUuid = isUuid;
    const empty = (0, util.deprecate)(() => esmNode.NIL, 'empty() is deprecated. Use NIL from the uuid module instead.');
    exports.empty = empty;
    const fromString = (0, util.deprecate)((text, namespace = 'bb5d0ffa-9a4c-4d7c-8fc2-0a7d2220ba45') => (0, esmNode.v5)(text, namespace), 'fromString() is deprecated. Use v5() from the uuid module instead.');
    exports.fromString = fromString;
    });

    unwrapExports(uuidv4_1);
    var uuidv4_2 = uuidv4_1.jsonSchema;
    var uuidv4_3 = uuidv4_1.fromString;
    var uuidv4_4 = uuidv4_1.empty;
    var uuidv4_5 = uuidv4_1.isUuid;
    var uuidv4_6 = uuidv4_1.regex;
    var uuidv4_7 = uuidv4_1.uuid;
      ...
      return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
        ...
        var req = transport.request(options, function handleResponse(res) {
          ...
          case 'deflate':
            ...
            stream$$1 = (res.statusCode === 204) ? stream$$1 : stream$$1.pipe(zlib.createUnzip());
    ...
    var ChatBot = /** @class */ (function () {
        function ChatBot(token) {
            ...
            this.token = token;
            this.conversationId = null;
            this.parentUUID = uuidv4_7();
        }
        ChatBot.prototype.sendPrompt = function (message) {
            return __awaiter(this, void 0, void 0, function () {
                var data, response, splitData, resultData, json, chatBotResponse, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, axios$1.post('https://chat.openai.com/backend-api/conversation', data, {
                                    headers: {
                        ...
                        case 2:
                            response = _a.sent();
                            splitData = response.data.split(/\r?\n/);
                            resultData = splitData[splitData.length - 7];
                            ...
                            try {
                                ...
                                return [2 /*return*/, chatBotResponse];
                            }
                            catch (error) {
                                throw error;
                            }
